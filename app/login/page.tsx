    ...
    <div className="min-h-screen grid md:grid-cols-2">
      <div className="hidden md:flex bg-black relative">
        ...
        <div className="relative z-10 p-12 flex flex-col justify-end text-white">
          ...
          <p className="mt-4 text-white/80">Kelola pernikahan impian dari Gresik untuk Indonesia.</p>
        </div>
      </div>
      <div className="flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            ...
            <button onClick={(e)=>login(e,'rina.budi@gmail.com','klien123')} className="border rounded-xl p-3 text-left hover:bg-pink-50">
          ...
          <form onSubmit={login} className="mt-8 space-y-4">
            ...
            <button disabled={loading} className="w-full bg-black text-white rounded-xl py-3 font-semibold">{loading ? 'Memproses...' : 'Masuk'}</button>
          </form>
        </div>
      </div>
    </div>
